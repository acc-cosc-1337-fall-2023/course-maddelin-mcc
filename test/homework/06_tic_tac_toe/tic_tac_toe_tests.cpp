...
TEST_CASE("Test if there is a tie"){
	unique_ptr<TicTacToe> game = make_unique<TicTacToe>(3);
...
TEST_CASE("Test TicTacToeManager.get_winner_total")
{
	...
	//game 1, x will win
	unique_ptr<TicTacToe> game1 = make_unique<TicTacToe>(3);
	game1->start_game("X");
	game1->mark_board(7);
	game1->mark_board(6);
	game1->mark_board(5);
	...
	//game2, will be a tie
	unique_ptr<TicTacToe> game2 = make_unique<TicTacToe>(3);
	game2->start_game("X");
	game2->mark_board(1);
	game2->mark_board(2);
	game2->mark_board(3);
	...
	unique_ptr<TicTacToe> game3 = make_unique<TicTacToe>(3);
	game3->start_game("X");
	game3->mark_board(2);
	game3->mark_board(1);
	game3->mark_board(5);
	...
	unique_ptr<TicTacToe> game4 = make_unique<TicTacToe>(3);
	game4->start_game("O");
	game4->mark_board(2);
	game4->mark_board(1);
	game4->mark_board(5);
